...
class MainWidget(RelativeLayout):
    ...
    from user_actions import on_touch_down, on_keyboard_down, on_keyboard_up, on_touch_up, keyboard_closed
    ...
    def __init__(self, **kwargs):
        ...
        # print("ON W:" + str(self.width) + "H" + str(self.height))
        self.init_audio()
    ...
    def init_audio(self):
        ...
        self.sound_galaxy_voice.volume = .4
    ...
    def update(self, dt):
        ...
        if not self.check_ship_collisions() and not self.state_game_over:
            ...
            Clock.schedule_once(self.play_voice_gameover, 1.5)
            print("Game Over")
